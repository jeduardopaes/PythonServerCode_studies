...
#
# The server should be listening on port 7001, answer a GET request to /
...
def test_connect():
    ...
    try:
        ...
        return "Server didn't answer on localhost port 7001.  Is it running?"
...
def test_GET_path():
    ...
    uri = "http://localhost:7001/google"
